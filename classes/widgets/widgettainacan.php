...
class PeepSoWidgetTainacan extends WP_Widget
{
    ...
    public function __construct($id = null, $name = null, $args= null) {
        if(!$id)    $id     = 'PeepSoWidgetTainacan';
        if(!$name)  $name   = __( 'PeepSo Tainacan', 'tainacan-peepso' );
        if(!$args)  $args   = array( 'description' => __( 'PeepSo Tainacan Widget', 'tainacan-peepso' ), );
    ...
    public function form( $instance ) {
		...
		if (!isset($instance['title'])) {
			$instance['title'] = __('Tainacan', 'tainacan-peepso');
		}
